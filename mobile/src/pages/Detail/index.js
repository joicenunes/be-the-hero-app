    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.details}>
                <Text style={[styles.detailsProperty, styles.first]}>CASO</Text>
                <Text style={styles.detailsValue}>{ incident.title }</Text>
                <Text style={styles.detailsProperty}>DESCRIÇÃO</Text>
                <Text style={styles.detailsValue}>{ incident.description }</Text>
                <Text style={styles.detailsProperty}>VALOR</Text>
                <Text style={styles.detailsValue}>{ Intl.NumberFormat('pt-BR', {
                    style: 'currency',
                    currency: 'BRL'
                }).format(incident.value) }</Text>
                <Text style={styles.detailsProperty}>ONG</Text>
                <Text style={styles.detailsValue}>{ incident.name }</Text>
            </View>
